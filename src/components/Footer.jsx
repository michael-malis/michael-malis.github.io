export default function Footer() {
  return (
    <footer className="border-t border-[var(--color-border)] px-6 py-16 text-center">
      ...
      <p className="font-mono text-sm text-[var(--color-text-muted)]">© 2026 Michael Malis</p>
      <p className="mt-2 font-mono text-sm text-[var(--color-text-muted)]">Built with React, Vite and Tailwind CSS</p>
      <p className="mt-2">
        <a
